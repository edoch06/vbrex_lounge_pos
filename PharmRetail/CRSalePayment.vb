...
Public Class CRSalePayment
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PharmRetail.CRSalePayment.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRSalePayment
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRSalePayment = New CRSalePayment
        rpt.Site = Me.Site
        Return rpt
    End Function
