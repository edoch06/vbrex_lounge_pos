...
Public Class CRSaleSummary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PharmRetail.CRSaleSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRSaleSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRSaleSummary = New CRSaleSummary
        rpt.Site = Me.Site
        Return rpt
    End Function
