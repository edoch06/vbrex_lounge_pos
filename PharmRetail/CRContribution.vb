...
Public Class CRContribution
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PharmRetail.CRContribution.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRContribution
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRContribution = New CRContribution
        rpt.Site = Me.Site
        Return rpt
    End Function
